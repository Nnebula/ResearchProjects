...
void DNA_elastin_pulling()
{
    ...
    ofstream outWLC;
    outWLC.open("/Users/Naanaa/Documents/research/Trap_WLC_simulation/DNAelastinPulling_20120125/DNA680_elastin166_vp20_fs1kHz_noise.txt");
    ...
    outWLC<<"n"<<","<<"time"<<","<<"extension_total"<<","<<"force"<<","<<"extension_DNA"<<","<<"extension_elastin"<<","<<"WLC_DNA"<<","<<"WLC_elastin"<<","<<"extension_change"<<","<<"force_change"<<","<<"WLC_change"<<","<<"extension_DNA/L_DNA"<<endl;
    ...
    do{
        ...
        //write in the file
        if(n%1000==0){
            outWLC<<n<<","<<time<<","<<extension_total<<","<<force<<","<<extension_DNA<<","<<extension_elastin<<","<<WLC_DNA<<","<<WLC_elastin<<","<<extension_DNA-extension_old<<","<<force-f_old<<","<<WLC_DNA-WLC_old<<","<<extension_DNA/L_DNA<<endl;
            outWLC.flush();
        }
